...
import { StyledAccount } from './MyAccount.styled';
        ...
        <section id='user-info'>
              ...
              <>
                {user?.map((item) => (
                  <div key={item._id}>
                    ...
                    <p>{item.email}</p>
                    <p>Cars for sale: {item.cars.length}</p>
                    <button
          ...
          <div id='user-cars--container'>
            ...
            <div id='user-cars--add-new' className='card-shadow'>
              <h6 className='text-center'>Got cars for sale?</h6>
              <h2 className='text-center'>Enter car information</h2>
